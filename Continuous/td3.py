...
for i in range(10000):
    ...
    print("\rPopulating Buffer {}/{}.".format(i, 10000), end="")
...
while frame_idx < max_frames:
    ...
    print(f"Episode: {len(rewards)} -> Reward: {episode_reward:.2f} -> Steps: {replay_buffer.position}")
